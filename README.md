...
People who are involved in indoor positioning technology can calculate their estimation's indicator and requirement for PDR and VDR.  
Indicator means evaluation value that is generally used for PDR and VDR and requirement means validity that thajection is natural for real human behavior.  
